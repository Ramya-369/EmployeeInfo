...
public class DepartmentController {
	...
	@Operation(summary = "Adds a new department", description = "To create and add a new department to the system.")// Operation annotation provides metadata for the Swagger documentation
	   @ApiResponses (value= {
...
//	}
	...
	@Operation(summary = "Updates an existing department", description = "To modify the details of an existing department")// Operation annotation provides metadata for the Swagger documentation
	@ApiResponses (value= {
	...
	public Department updateDepartment(
	    @PathVariable("departmentId") String departmentId,@Valid @RequestBody Department department) {
