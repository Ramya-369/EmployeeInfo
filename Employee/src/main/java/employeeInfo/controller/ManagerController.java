...
public class ManagerController {
	...
	public List<Manager> getManagers(){
		// Call the managerService to get the list of managers
	...
	@Operation(summary = "Adds a new manager", description = "To create and add a new manager to the system.")// Operation annotation provides metadata for the Swagger documentation
	@ApiResponses (value=  {
	...
	// Call the managerService to add the  manager
	return managerService.addNewManager(manager);
   }

	@PutMapping("/updateEmployee/{managerId}")// This endpoint handles PUT requests for "/api/managers"
	@Operation(summary = "Updates an existing manager", description = "To modify the details of an existing manager")// Operation annotation provides metadata for the Swagger documentation
	@ApiResponses (value= {
...
public Manager updateManager(@PathVariable("managerId") Integer managerId, @Valid @RequestBody Manager manager) {
	// Call the managerService to update the manager
