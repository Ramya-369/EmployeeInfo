...
public class EmployeeController {
	...
	@Operation(summary = "Adds a new employee", description = "To create and add a new employee to the system.")// Operation annotation provides metadata for the Swagger documentation
	@ApiResponses (value= {
...
public Employee addNewEmployee(@Valid @RequestBody Employee employee) {
	...
	@Operation(summary = "Updates an existing employee", description = "To modify the details of an existing employee")// Operation annotation provides metadata for the Swagger documentation
	@ApiResponses (value= {
    ...
    public Employee updateEmployee(@PathVariable("employeeId") Integer employeeId, @Valid @RequestBody Employee employee) {
